...
if(UNIX)
    if(BUILD_DEB)
        ...
        set(CPACK_DEBIAN_PACKAGE_DEPENDS "qt6-base-dev (>= 6.8), qt6-tools-dev, qt6-tools-dev-tools")
    endif()
    ...
    if(BUILD_RPM)
        ...
        if(LSB_RELEASE_ID_SHORT EQUAL "openSUSE")
            set(CPACK_RPM_BUILDREQUIRES "cmake >= 3.9, libqt6-qtbase-common-devel >= 6.8, libQt6Core-devel, libQt6Gui-devel, libQt6Network-devel, libQt6Widgets-devel, libQt6Concurrent-devel, libqt6-linguist-devel, libqt6-qtsvg-devel, update-desktop-files, ninja")
        else()
            set(CPACK_RPM_BUILDREQUIRES "cmake >= 3.9, qt6-qtbase-devel >= 6.8, qt6-qttools-devel, qt6-qttools-linguist, qt6-qtsvg-devel, desktop-file-utils, ninja-build")
        endif()
