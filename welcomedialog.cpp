...
auto WelcomeDialog::getContestTitle() -> QString
{
	return ui->newContestWidget->getContestTitle();
}

auto WelcomeDialog::getSavingName() -> QString
{
	return ui->newContestWidget->getSavingName();
}

auto WelcomeDialog::getContestPath() -> QString
{
...
auto WelcomeDialog::getCurrentTab() const -> int
{
